    ...
    <div className="w-full">
      ...
      <div className="relative">
        ...
        <select
          ...
          } bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 focus:ring-2 focus:ring-offset-0 transition-colors ${
            icon ? 'pl-10' : 'pl-3'
          } pr-10 py-2 text-sm appearance-none cursor-pointer ${className}`}
          {...props}
        >
          {children ||
            options.map((option) => (
