  ...
  if (!isAdmin) {
    return (
      <div className="flex flex-col items-center justify-center h-64 text-center">
        ...
        <p className="text-white/60">You don't have permission to access this admin tool.</p>
      </div>
    );
  }
    ...
    return (
      <div className="p-6">
        <div className="flex items-start justify-between gap-4 mb-6">
          <div>
            <h1 className="text-xl font-semibold text-white">Jamaican Payroll Monitor</h1>
    ...
    <div className="p-6">
      ...
      <div className="mb-6">
        <div className="bg-white/5 border border-white/10 rounded-lg p-6">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg font-medium text-white">Migration Readiness</h2>
          ...
          {monitoringData.migrationReadiness.issues.length > 0 && (
            <div className="mb-4">
              <h3 className="text-sm font-medium text-white/80 mb-2">Issues to Address:</h3>
          ...
          {monitoringData.migrationReadiness.recommendations.length > 0 && (
            <div>
              <h3 className="text-sm font-medium text-white/80 mb-2">Recommendations:</h3>
              <ul className="space-y-1">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-white/5 border border-white/10 rounded-lg p-4">
          ...
          <div className="text-2xl font-bold text-white">{monitoringData.totalAuditRecords}</div>
          <div className="text-sm text-white/60">Audit Records</div>
        </div>
        ...
        <div className="bg-white/5 border border-white/10 rounded-lg p-4">
          ...
          <div className="text-2xl font-bold text-white">{monitoringData.totalEmployees}</div>
        ...
        <div className="bg-white/5 border border-white/10 rounded-lg p-4">
          ...
          <div className="text-sm text-white/60">Net Pay Difference</div>
        </div>
        ...
        <div className="bg-white/5 border border-white/10 rounded-lg p-4">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-xs text-white/60">Largest</span>
          </div>
          <div className="text-2xl font-bold text-white">
            {new Intl.NumberFormat('en-JM', {
              style: 'currency',
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-white/80">Valid</span>
              </div>
              <span className="text-lg font-semibold text-white">{monitoringData.validationStatusCounts.valid}</span>
            </div>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <AlertTriangle className="w-4 h-4 text-yellow-400" />
                <span className="text-sm text-white/80">Warning</span>
              </div>
              <span className="text-lg font-semibold text-white">{monitoringData.validationStatusCounts.warning}</span>
            </div>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-semibold text-white">{monitoringData.validationStatusCounts.error}</span>
            </div>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-semibold text-white">{monitoringData.validationStatusCounts.not_available}</span>
            </div>
          </div>
        </div>
        ...
        {/* Warning Frequency */}
        <div className="bg-white/5 border border-white/10 rounded-lg p-6">
          <h2 className="text-lg font-medium text-white mb-4">Warning Frequency</h2>
            ...
            <div className="space-y-2">
              {monitoringData.warningAnalysis.mostCommonWarnings.slice(0, 5).map((warning: any, index: number) => (
                <div key={index} className="flex items-center justify-between">
                  <span className="text-sm text-white/70 truncate flex-1 mr-2">{warning.warning}</span>
      ...
      <div className="bg-white/5 border border-white/10 rounded-lg p-6">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-medium text-white">Recent Audit Activity</h2>
              ...
              <div key={index} className="flex items-center justify-between p-3 bg-white/5 rounded-lg">
                <div className="flex items-center gap-3">
                  <div className={`w-2 h-2 rounded-full ${
                    ...
                    audit.validationStatus === 'error' ? 'bg-red-400' : 'bg-gray-400'
                  }`} />
                  <div>
                    <div className="text-sm font-medium text-white">{audit.employeeId}</div>
                ...
                <div className="text-right">
                  <div className={`text-xs px-2 py-1 rounded-full ${
                    ...
                    audit.validationStatus === 'error' ? 'bg-red-500/20 text-red-400' : 'bg-gray-500/20 text-gray-400'
                  }`}>
