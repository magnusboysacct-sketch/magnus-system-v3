...
export default function SettingsImportPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#080b10]">
      <PageHeader
        title="Import Data"
        subtitle="Bring in clients, projects, expenses, invoices, vendors, bills, field payments, vendor payments, and your chart of accounts from another system — mapped, deduplicated, and reviewed before anything is saved."
      />
