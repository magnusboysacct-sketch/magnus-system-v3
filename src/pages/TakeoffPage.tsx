    ...
    <div className="h-screen bg-slate-950 text-white flex flex-col">
      ...
      <div className="flex-1 relative flex items-center justify-center">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="w-[320px] rounded-2xl border border-slate-700 bg-slate-900 p-6 text-center shadow-xl">
            <div className="mb-4 text-slate-400">📁</div>
            <div className="text-sm font-semibold mb-2">No drawing loaded</div>
            <div className="text-xs text-slate-400 mb-4">
              Upload a PDF or image to begin measuring.
            </div>
            <button className="px-4 py-2 rounded-lg bg-slate-700 hover:bg-slate-600 text-sm">
              Upload Drawing
            </button>
