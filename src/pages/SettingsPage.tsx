...
const SETTINGS_SECTIONS = [
  ...
  { title: "Import Data", desc: "Bring in clients, projects, expenses, invoices, vendors, bills, field payments, vendor payments, and your chart of accounts from another system", icon: <UploadCloud size={18}/>, to: "/settings/import", color: "text-orange-400 bg-orange-500/10 border-orange-500/20" },
