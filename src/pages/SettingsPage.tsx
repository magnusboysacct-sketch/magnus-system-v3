...
import { Settings, BookOpen, Users, Building2, CreditCard, ArrowRight, FileText, Percent, Banknote, UploadCloud } from "lucide-react";
...
const SETTINGS_SECTIONS = [
  ...
  { title: "Payroll & Tax Rates", desc: "Jamaican statutory deduction rates — update when government changes rates", icon: <Banknote size={18}/>, to: "/settings/payroll-rates", color: "text-green-400 bg-green-500/10 border-green-500/20" },
  ...
  { title: "Import Data", desc: "Bring in clients, projects, expenses, invoices, vendors, bills, field payments, vendor payments, customer payments, fund transfers, and your chart of accounts from another system", icon: <UploadCloud size={18}/>, to: "/settings/import", color: "text-orange-400 bg-orange-500/10 border-orange-500/20" },
